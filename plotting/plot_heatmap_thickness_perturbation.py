...
def heat_map(csv_file):
    ...
    # specify thickness perturbation [%] and axon tract stiffness [N/m^2]
    ...
    g.set_xlabel(r"axon tract stiffness $K_{\rm eff}$ [N/m$^2$]")
    g.set_ylabel(r'thickness perturbation $\xi/H_{\rm c}$ [\%]')
    ...
    png2.save('figure_heatmap_thickness_perturbation.tiff')
    png1.close()

    plt.savefig("figure_heatmap_thickness_perturbation.png")
    plt.show()
